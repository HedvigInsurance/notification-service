...
import com.hedvig.notificationService.serviceIntegration.memberService.dto.BankIdAuthRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.BankIdAuthResponse;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.BankIdCollectResponse;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.BankIdSignRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.BankIdSignResponse;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.FinalizeOnBoardingRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.FinalizeOnBoardingResponse;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.Member;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.SendActivatedRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.SendOnboardedActiveLaterRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.SendOnboardedActiveTodayRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.SendSignupRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.SendWaitIsOverRequest;
import com.hedvig.notificationService.serviceIntegration.memberService.dto.StartOnboardingWithSSNRequest;
