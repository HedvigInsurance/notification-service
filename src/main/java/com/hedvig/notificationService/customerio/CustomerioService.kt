...
class CustomerioService(
    ...
    fun updateCustomerAttributes(
        ...
        clients[marketForMember]?.updateCustomer(memberId, attributes.replaceWithUnixTimestamp())
    }
    ...
    fun sendEvent(memberId: String, body: Map<String, Any?>) {
        ...
        clients[marketForMember]?.sendEvent(memberId, mutableMap.toMap().replaceWithUnixTimestamp())
